...
@section('title', __('portfolio.title')) {{-- Set the title --}}
...
<div class="bg-white/80 backdrop-blur-md p-8 rounded-lg shadow-lg border border-white/20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        <div class="md:col-span-1 flex justify-center">
            <img src="{{ asset('assets/images/logo_tron.png') }}" alt="Ảnh đại diện" class="rounded-full h-48 w-48 object-cover border-4 border-white/50 shadow-lg">
        </div>
    ...
    <div>
        ...
        <div class="max-w-2xl mx-auto bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-white/30 flex items-center space-x-6 transition-all duration-300 hover:shadow-xl hover:border-gray-400/50">
            <div class="flex-shrink-0 bg-indigo-500/10 p-4 rounded-full">
                <img src="https://tdtu.edu.vn/sites/www/files/logo-dh_0.png" alt="Logo Đại học Tôn Đức Thắng" class="h-12 w-12 object-contain">
            </div>
            <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-white/50 backdrop-blur-sm p-4 rounded-2xl border border-white/30 flex items-center space-x-4 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border-red-500/50">
                ...
                <div>
                    ...
                    <a href="https://verify.certiport.com/" target="_blank" class="text-xs text-blue-600 hover:underline font-mono">{{ __('portfolio.cert_mos_verify') }}</a>
                </div>
            </div>
