            ...
            ->schema([
                ...
                Grid::make(2)
                    ->schema([
                        ...
                        // Trường Email lấy từ user.email
                        TextInput::make('user.email')
                            ...
                            ->afterStateHydrated(function (TextInput $component, $state, $record) {
                                // Khi form được load, đặt giá trị ban đầu từ $record->user->email
                            ...
                            ->unique('users', 'email') // Email không được trùng trong bảng personalinfos
                            // ->rules([
    ...
    public static function creating(PersonalInfo $record)
    {
        if (!User::where('email', $record->email)->exists()) {
            User::create([
                ...
                'email' => $record->email,
                'password' => bcrypt($record->identitynumber),
            ]);
        }
    }
